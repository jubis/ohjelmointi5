...
public class Pelipaneeli extends JPanel {
	 ...
	 */
	public static MiinaharavaRuutu luoSopivaMiinaharavaRuutu( Point sijainti, boolean miina ) {
		return new Ruutunappi( sijainti, miina );
	}
	
	@Deprecated
	private static void vaihdaVari( Color vari, Component komponentti ) {
		komponentti.setBackground( vari );
	}
}
